...
sig<-read.table("/data/home/pooja/GWAS/SNC/annotate/SNC_IvsT_fdr0.05.bed.anno.genes4GO",header=F)
dim(sig)
...
write.table(allRes_BP, file="/data/home/pooja/GWAS/SNC/annotate/SNC_IvsT_fdr0.05.bed.anno.genes4GO.BPenrichment", quote=FALSE, row.names=FALSE, sep="\t")
...
write.table(allRes_CC, file="/data/home/pooja/GWAS/SNC/annotate/SNC_IvsT_fdr0.05.bed.anno.genes4GO.CCenrichment", quote=FALSE, row.names=FALSE, sep="\t")
...
write.table(allRes_MF, file="/data/home/pooja/GWAS/SNC/annotate/SNC_IvsT_fdr0.05.bed.anno.genes4GO.MFenrichment", quote=FALSE, row.names=FALSE, sep="\t")
